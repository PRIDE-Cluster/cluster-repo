...
CREATE
INDEX assay_project_IDX ON assay
(
  project_accession ASC
)
TABLESPACE PRIDECLUS_IND LOGGING ;
CREATE
INDEX assay_species_IDX ON assay
(
  species ASC
)
TABLESPACE PRIDECLUS_IND LOGGING ;
CREATE
INDEX assay_tax_id_IDX ON assay
(
  taxonomy_id ASC
)
TABLESPACE PRIDECLUS_IND LOGGING ;
CREATE
INDEX assay_search_engine_IDX ON assay
(
  search_engine ASC
)
TABLESPACE PRIDECLUS_IND LOGGING ;
CREATE
INDEX assay_instrut_type_IDX ON assay
(
  instrument_type ASC
)
TABLESPACE PRIDECLUS_IND LOGGING ;
CREATE
INDEX assay_instrut_IDX ON assay
(
  instrument ASC
)
TABLESPACE PRIDECLUS_IND LOGGING ;
...
TABLESPACE PRIDECLUS_TAB LOGGING ;
CREATE
INDEX psm_has_cluster_IDX ON cluster_has_psm
(
  psm_fk ASC ,
  cluster_fk ASC
)
TABLESPACE PRIDECLUS_IND LOGGING ;
CREATE
INDEX cluster_ratio_rank_IDX ON cluster_has_psm
(
  ratio ASC ,
  rank ASC
)
TABLESPACE PRIDECLUS_IND LOGGING ;
CREATE
INDEX cluster_has_psm_IDX ON cluster_has_psm
(
  cluster_fk ASC ,
  psm_fk ASC
)
TABLESPACE PRIDECLUS_IND LOGGING ;
ALTER TABLE cluster_has_psm ADD CONSTRAINT cluster_has_psm_PK PRIMARY KEY (
  cluster_fk, psm_fk ) ;

CREATE
TABLE cluster_has_spectrum
(
  cluster_fk  INTEGER NOT NULL ,
...
TABLESPACE PRIDECLUS_IND LOGGING ;
CREATE
INDEX cluster_spec_sim_IDX ON cluster_has_spectrum
(
  similarity ASC
)
TABLESPACE PRIDECLUS_IND LOGGING ;
...
TABLESPACE PRIDECLUS_IND LOGGING ;
ALTER TABLE cluster_has_spectrum ADD CONSTRAINT cluster_to_spectrum_PK
PRIMARY KEY ( cluster_fk, spectrum_fk ) ;
...
TABLESPACE PRIDECLUS_TAB LOGGING ;
CREATE
INDEX psm_sequence_IDX ON psm
(
  sequence ASC
)
TABLESPACE PRIDECLUS_IND LOGGING ;
CREATE
INDEX psm_spectrum_IDX ON psm
(
  spectrum_fk ASC
)
TABLESPACE PRIDECLUS_IND LOGGING ;
CREATE
INDEX psm_assay_IDX ON psm
(
  assay_fk ASC
)
TABLESPACE PRIDECLUS_IND LOGGING ;
CREATE
INDEX psm_sequence_mod_IDX ON psm
(
  sequence ASC ,
  modifications ASC
)
TABLESPACE PRIDECLUS_IND LOGGING ;
CREATE
INDEX psm_spectrum_fk_pk_seq_IDX ON psm
(
  spectrum_fk ASC ,
  psm_pk ASC ,
  sequence ASC
...
TABLESPACE PRIDECLUS_TAB LOGGING ;
CREATE
INDEX spectral_library_rdate_IDX ON spectral_library
(
  release_date ASC
)
TABLESPACE PRIDECLUS_IND LOGGING ;
...
TABLESPACE PRIDECLUS_TAB LOGGING ;
CREATE
INDEX spectrum_ref_IDX ON spectrum
(
  spectrum_ref ASC ,
  spectrum_pk ASC
)
TABLESPACE PRIDECLUS_IND LOGGING ;
CREATE
INDEX spectrum_precursor_mz_IDX ON spectrum
(
  precursor_mz ASC
)
TABLESPACE PRIDECLUS_IND LOGGING ;
...
TABLESPACE PRIDECLUS_TAB LOGGING ;
CREATE
INDEX cluster_precursor_mz_IDX ON spectrum_cluster
(
  avg_precursor_mz ASC
)
TABLESPACE PRIDECLUS_IND LOGGING ;
CREATE
INDEX cluster_num_spectra_ratio_IDX ON spectrum_cluster
(
...
TABLESPACE PRIDECLUS_IND LOGGING ;
CREATE
INDEX spectrum_cluster_quality_IDX ON spectrum_cluster
(
  quality ASC
)
TABLESPACE PRIDECLUS_IND LOGGING ;
...
ALTER TABLE spectrum_cluster ADD CONSTRAINT spectrum_cluster_uuid_UN UNIQUE (
  uuid ) ;

ALTER TABLE cluster_has_psm ADD CONSTRAINT cluster_has_psm_cluster_FK FOREIGN
KEY ( cluster_fk ) REFERENCES spectrum_cluster ( cluster_pk ) ON
DELETE
CASCADE NOT DEFERRABLE ;

ALTER TABLE cluster_has_psm ADD CONSTRAINT cluster_has_psm_psm_FK FOREIGN KEY (
  psm_fk ) REFERENCES psm ( psm_pk ) ON
DELETE
CASCADE NOT DEFERRABLE ;

ALTER TABLE cluster_has_spectrum ADD CONSTRAINT cluster_to_spec_spec_FK FOREIGN
KEY ( spectrum_fk ) REFERENCES spectrum ( spectrum_pk ) ON
DELETE
CASCADE NOT DEFERRABLE ;

ALTER TABLE cluster_has_spectrum ADD CONSTRAINT cluster_to_spectrum_cluster_FK
FOREIGN KEY ( cluster_fk ) REFERENCES spectrum_cluster ( cluster_pk ) ON
DELETE
CASCADE NOT DEFERRABLE ;

ALTER TABLE psm ADD CONSTRAINT psm_assay_FK FOREIGN KEY ( assay_fk ) REFERENCES
  assay ( assay_pk ) ON
DELETE
CASCADE NOT DEFERRABLE ;

ALTER TABLE psm ADD CONSTRAINT psm_spectrum_FK FOREIGN KEY ( spectrum_fk )
REFERENCES spectrum ( spectrum_pk ) ON
DELETE
CASCADE NOT DEFERRABLE ;

ALTER TABLE spectrum ADD CONSTRAINT spectrum_assay_FK FOREIGN KEY ( assay_fk )
REFERENCES assay ( assay_pk ) ON
DELETE
CASCADE NOT DEFERRABLE ;
...
INSERT
ON assay FOR EACH ROW WHEN
(
  NEW.assay_pk IS NULL
)
  BEGIN :NEW.assay_pk := assay_pk_sequence.NEXTVAL;
  END;
/
...
INSERT
ON psm FOR EACH ROW WHEN
(
  NEW.psm_pk IS NULL
)
  BEGIN :NEW.psm_pk := psm_pk_sequence.NEXTVAL;
  END;
/

CREATE SEQUENCE spectrum_pk_sequence START WITH 1 INCREMENT BY 1000 NOCACHE
ORDER ;
CREATE OR REPLACE TRIGGER spectrum_spectrum_pk_TRG BEFORE
INSERT
ON spectrum FOR EACH ROW WHEN
(
  NEW.spectrum_pk IS NULL
)
  BEGIN :NEW.spectrum_pk := spectrum_pk_sequence.NEXTVAL;
  END;
/
...
INSERT
ON spectrum_cluster FOR EACH ROW WHEN
(
  NEW.cluster_pk IS NULL
)
  BEGIN :NEW.cluster_pk := cluster_pk_sequence.NEXTVAL;
  END;
/
